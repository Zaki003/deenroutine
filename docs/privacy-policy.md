...
- **Prayer log:** If you mark your prayers as prayed on the Prayer screen, a record of which of the five daily prayers you logged each day and whether each was on time, late, made up (qada), not prayed or excused. It's used to show your prayer stats on your profile. Only you can see it; it's never shared or used for analytics.
